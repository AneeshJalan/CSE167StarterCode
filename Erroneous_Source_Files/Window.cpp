...
bool Window::initializeObjects()
{
	...
	// Read all .obj files
	objPoints.push_back(new PointCloud("./Objects/bunny.obj", 10));
	objPoints.push_back(new PointCloud("./Objects/bear.obj", 10));
	objPoints.push_back(new PointCloud("./Objects/dragon.obj", 10));
...
void Window::keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	...
	if (action == GLFW_PRESS)
	{
		...
		std::cerr << "Address of current object: " << currentObj << std::endl;
	}
}
